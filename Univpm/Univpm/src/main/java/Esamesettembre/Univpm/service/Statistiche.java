...
public class Statistiche {
		...
		/**
		 * Metodo che restituisce una lista nella quale vengono visualizzate tutte le statistiche numeriche 
		 * 
		 * @param lista fornisce i valori con i quali si possono calcolare tutte le statistiche
		 * @return list che contiene il nome della statistica e il valore calcolato tramite i metodi della classe
		 */
		public static List<String> NumStats(String campo, List<Number> lista){
			List<String> list = new ArrayList<>();  //crea una lista che serve a contenere i valori delle statistiche numeriche
		...
		/**
		 * Metodo che restituisce una lista nella quale vengono visualizzate tutte le statistiche degli attributi non numerici
		 * 
		 * @param lista fornisce i valori con i quali si possono calcolare tutte le statistiche non numeriche
		 * @return lst che contiene il nome della statistica e il valore calcolato tramite i metodi della classe
		 */
		 ...
		 * 
		 * @param campo contiene il nome dell'attributo del quale si vogliono calcolare le statistiche 
		 * @param list contiene la lista dei valori utili per il calcolo delle statistiche
		 * @return lst1 che contiene o la lista delle statistiche numeriche se attributo numerico o quella delle statistiche non numeriche se attributo non numerico
		 */
